...
public class NumberRangeTest {
    ...
    private String url = "https://flow.intici.saptfe-demo.com/http/ha/getNumberRange";
    private String auth = "Basic xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
