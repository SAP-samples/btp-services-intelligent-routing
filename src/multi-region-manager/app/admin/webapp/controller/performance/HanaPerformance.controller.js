sap.ui.define(
  ...
  function (
    ...
    return BaseController.extend(
      "com.sap.region.manager.ui.controller.performance.HanaPerformance",
      {
        formatter: formatter,
        onInit: function () {
          ...
          performance.sda(formatter).forEach(function (config) {
          ...
          this._updateChartContainerContent("create");
        },
