sap.ui.define([
	...
	return BaseController.extend("com.sap.region.manager.ui.controller.monitor.AemMonitorReplication", {
		formatter: formatter,
		onInit : function () {
			var oViewModel, oTableModel;
			this.region = "primary";
			this.getRouter().getRoute("aemMonitorReplication").attachPatternMatched(this._onObjectMatched, this);
		...
		onRefresh : function () {
			this.getModel().loadData("/api/aemReplicationStatus?region="+this.region);
		},
